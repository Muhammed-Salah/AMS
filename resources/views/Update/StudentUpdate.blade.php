...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary text-light">{{ __('Update Student') }}</div>
                    ...
                    <form method="POST" action="{{route('student.edit', $id->id)}}">
                        <div class="col-md-12 mt-3">
                            <div class="border border-dark p-2 mb-2 d-flex justify-content-between"></div>
                                    ...
                                    <div>
                                                <span class="lead">
                                                    @csrf
                                                    <label><input name="class" type="radio" id="class" type="text" name="class" value="8">8th</label>
                                                    <label><input name="class" type="radio" id="class" type="text" name="class" value="9">9th</label>
                                                    <label><input name="class" type="radio" id="class" type="text" name="class" value="10">10th</label>
                                                    @foreach($errors->get('name') as $err )  <!-- used for printing multiple errors -->
                                                    <small class="text-danger">{{ $err }}</small>
                                                    @endforeach
                                                </span>
